  ...
  if (loading) {
    return (
      <div className="google-docs-page">
        <div className="google-docs-page__header">
          <div className="google-docs-page__header-content">
            <h1 className="google-docs-page__header-title">Google Docs Management</h1>
            <p className="google-docs-page__header-description">Loading your documents...</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="google-docs-page">
      ...
      <div className="google-docs-page__header">
        <div className="google-docs-page__header-content">
          <h1 className="google-docs-page__header-title">Google Docs Management</h1>
          <p className="google-docs-page__header-description">
            Import, sync, and manage all your Google Docs in one unified interface
          </p>
        </div>
        <div className="google-docs-page__header-actions">
          <button
      ...
      {/* Import Form */}
      {showImport && (
        <div className="google-docs-page__import-form">
          <h2 className="google-docs-page__import-form-title">Import Google Doc</h2>
          <p className="google-docs-page__import-form-description">
      ...
      {imports.length === 0 && !showImport && (
        <div className="google-docs-page__empty-state">
          <div className="google-docs-page__empty-state-icon">
            <FileText style={{ width: '48px', height: '48px', opacity: 0.5 }} />
          </div>
          <h3 className="google-docs-page__empty-state-title">No Google Docs imported yet</h3>
          <p className="google-docs-page__empty-state-description">
      ...
      {/* Table */}
      {imports.length > 0 && (
        <div className="google-docs-page__table-wrapper">
          <div className="google-docs-page__table-header">
            <h2 className="google-docs-page__table-header-title">Imported Documents</h2>
            <p className="google-docs-page__table-header-description">
              {imports.length} document{imports.length !== 1 ? 's' : ''} imported
            </p>
          </div>
          <table className="google-docs-page__table">
            <thead>
              <tr>
                <th>Title</th>
                <th>Doc ID</th>
                ...
                <tr key={importItem.id}>
                  ...
                  <td>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                      <span
                        className={cn(
                          'google-docs-page__status-badge',
                          `google-docs-page__status-badge--${importItem.status}`
                        )}
                      >
